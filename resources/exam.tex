...
\bonusqformat{\textbf{\textcolor{headcolor}{\Large $if(PART)$$PART$.$endif$\thequestion: \theMyBonusQuestionTitle\hfill \fbox{\thepoints}}}}  % add only question points
